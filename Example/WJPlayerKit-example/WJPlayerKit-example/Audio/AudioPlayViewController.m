...
- (void)viewDidLoad {
    ...
    if (!_playerView) {
        ...
        [self.view addSubview:p];
        _playerView = p;
        [p playMedia:[[SimpleAudioMedia alloc] initWithVideoUrl:@"https://m10.music.126.net/20180929165532/044d87ba17c46883453b6ca8b0f3f535/ymusic/e47f/9bc5/2695/b74c4b8332994ffcb34a6f2c0080b9e6.mp3" posterUrl:@"https://p1.music.126.net/ADtuKwIN1n64E_DX8-N4ew==/109951163188720331.jpeg"] autoPlay:YES];
    }
